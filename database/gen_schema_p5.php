<?php
$sql = "CREATE TABLE IF NOT EXISTS `fixed_asset_stock_ins` (
...
$sql .= "CREATE TABLE IF NOT EXISTS `fixed_asset_stock_in_details` (
    `id` BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
...
$sql .= "CREATE TABLE IF NOT EXISTS `fixed_asset_stock_outs` (
    `id` BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    `reference_no` VARCHAR(255) DEFAULT NULL,
    `date` DATE DEFAULT NULL,
    `grand_total` DECIMAL(15,3) DEFAULT 0.000,
...
$sql .= "CREATE TABLE IF NOT EXISTS `fixed_asset_stock_out_details` (
    `id` BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
...
file_put_contents(__DIR__ . '/schema_part5.sql', $sql);
echo "Part 5 written: " . strlen($sql) . " bytes\n";