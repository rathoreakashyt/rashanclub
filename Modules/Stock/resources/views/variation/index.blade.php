...
@section('page-title', __('List') . ' ' . __('Variation'))
@push('page-css')
...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
        <div class="d-flex flex-column justify-content-center">
            <h4 class="mb-0">{{ __('List') }} {{ __('Variation') }}</h4>
        </div>
                ...
                <div class="card-datatable table-responsive pt-0">
                    <table class="datatables-basic table">
                        <thead>
                            <tr>
                                <th>{{ __('SN') }}</th>
                                <th>{{ __('Variation') }} {{ __('Name') }}</th>
                                <th>{{ __('Variation') }} {{ __('Value') }}</th>
                                <th>{{ __('Action') }}</th>
                            </tr>
                        </thead>
                        <tbody>
...
<script src="{{ asset('backend_assets/js/pages_list_js/list_variation_attribute.js')}}"></script>
