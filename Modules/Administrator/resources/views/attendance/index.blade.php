...
@section('page-title', __('List') . ' ' . __('Attendance'))
@push('page-css')
...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
        <div class="d-flex flex-column justify-content-center">
            <h4 class="mb-0">{{ __('List') }} {{ __('Attendance') }}</h4>
        </div>
    ...
    <!-- Total Hours Display -->
    <div class="card mb-4" id="totalHoursCard" style="display: none;">
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <h5 class="mb-0">
                        <strong>{{ __('Total Hours') }}: <span id="totalHoursDisplay">0</span> {{ __('hours') }}</strong>
                    </h5>
                </div>
            </div>
        </div>
...
<script src="{{ asset('backend_assets/js/pages_list_js/list_attendance.js')}}"></script>
