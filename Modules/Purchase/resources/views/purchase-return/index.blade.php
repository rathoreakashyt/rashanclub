...
@section('page-title', 'List Purchase Return')
@push('page-css')
...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
        <div class="d-flex flex-column justify-content-center">
            <h4 class="mb-0">{{ __('List') }} {{ __('Purchase Return') }}</h4>
        </div>
        @include('backend.components.breadcrumb', [
            'breadcrumbs' => [
                ...
                [
                    'label' => __('List') . ' ' .  __('Purchase Return'),
                    'active' => true
                ]
            ]
        ])
    ...
    @endif
    @if($status == 'success')
        {!! insertSuccess(__('Purchase created successfully')) !!}
    @endif
...
<script src="{{ asset('backend_assets/js/pages_list_js/list_purchase_return.js') }}"></script>
