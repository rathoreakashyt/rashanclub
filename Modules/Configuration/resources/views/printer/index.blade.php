...
@section('page-title', __('List') . ' ' . __('Printer'))
@push('page-css')
...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
        <div class="d-flex flex-column justify-content-center">
            <h4 class="mb-0">{{ __('List') }} {{ __('Printer') }}</h4>
        </div>
                    ...
                    <table class="datatables-basic table">
                        <thead>
                            <tr>
                                <th>{{ __('SN') }}</th>
                                <th>{{ __('Title') }}</th>
                                <th>{{ __('Printer') }} {{ __('Type') }}</th>
                                <th>{{ __('Characters Per Line') }}</th>
                                <th>{{ __('Printer IP Address') }}</th>
                                <th>{{ __('Printer Port Address') }}</th>
                                <th>{{ __('Share Name') }}</th>
                                <th>{{ __('Action') }}</th>
                            </tr>
                        </thead>
...
<script src="{{ asset('backend_assets/js/pages_list_js/list_printer.js')}}"></script>
