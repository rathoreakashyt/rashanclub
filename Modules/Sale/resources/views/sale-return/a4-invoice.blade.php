...
<body>
    <div id="wrapper" class="m-auto border-2s-e4e5ea br-5 p-30">
        ...
        <div class="d-flex justify-content-between">
            <div>
                ...
                @if($saleReturn->outlet)
                    <p class="pb-7">{{ $saleReturn->outlet->outlet_name ?? '' }}</p>
                    <p class="pb-7 f-w-500 color-71">{{ $saleReturn->outlet->address ?? '' }}</p>
                    <p class="pb-7 f-w-500 color-71">{{ __('Email') }}: {{ $saleReturn->outlet->email ?? '' }}</p>
                    <p class="pb-7 f-w-500 color-71">{{ __('Phone') }}: {{ $saleReturn->outlet->phone ?? '' }}</p>
                @endif
            </div>
        ...
        <div class="d-grid g-template-c-48-48 g-gap-2">
            <div class="d-flex justify-content-between">
                <div>
                    <h3 class="pb-7 common-heading">{{ __('Sale Return') }} {{ __('Info') }}</h3>
