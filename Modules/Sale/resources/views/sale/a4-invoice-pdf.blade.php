...
<body>
    ...
    <table class="header-table">
        <tr>
            <td width="50%" class="company-info">
                <h2 class="heading-title"><strong>{{ session('company.business_name', '') }}</strong></h2>
                @if($sale->outlet)
            ...
            <td width="50%" class="invoice-info" style="text-align:center; vertical-align:middle;">
                <div>
    ...
    <table style="margin-top:10px">
        <tr>
            <td width="50%" valign="top">
                <div class="heading-title"><strong>{{ __('Customer') }} {{ __('Information') }}</strong></div>
            ...
            <td width="50%" valign="top">
                <div class="heading-title"><strong>{{ __('Sale') }} {{ __('Information') }}</strong></div>
                <table class="info-table">
                    @if($sale->sale_no)
            ...
            <td width="40%" valign="top">
                <table class="summary-table">
                    ...
                    <tr>
                        ...
                        <td class="text-right">{{ formatAmount($taxData['amount']) }}</td>
                    </tr>
                        @endif
                    @endforeach
                    ...
                    <tr>
                        ...
                        <td class="text-right">{{ formatAmount($sale->delivery_charge) }}</td>
                    </tr>
                    @endif
                    <tr class="grand-total">
                        <td>{{ __('Grand Total') }}</td>
                        <td class="text-right">{{ formatAmount($sale->total_payable ?? $sale->grand_total) }}</td>
                    </tr>
                    <tr>
                        <td>{{ __('Paid Amount') }}</td>
                        <td class="text-right">{{ formatAmount($sale->paid_amount) }}</td>
                    </tr>
                    <tr>
                        <td>{{ __('Due Amount') }}</td>
                        <td class="text-right">{{ formatAmount($sale->due_amount) }}</td>
                    </tr>
    ...
    <!-- FOOTER -->
    @if(session('company.term_conditions'))
    <div class="footer">
        {!! session('company.term_conditions') !!}
    </div>
    @endif
    
    @if(session('company.invoice_footer'))
    <div class="footer">
        {!! session('company.invoice_footer') !!}
    </div>
    @endif
