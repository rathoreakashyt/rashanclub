...
@section('page-title', __('Sale Return Report'))
@push('page-css')
@endpush
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-datatable table-responsive pt-0">
                    <table class="datatables-basic table report-table" id="saleReturnReportTable">
                        <thead>
                            <tr>
                                <th>{{ __('SN') }}</th>
...
@push('page-js')
@routes
<script src="{{ asset('backend_assets/js/report/sale_return.js') }}"></script>
@endpush
