...
@section('page-title', __('Purchase Return Report'))
@push('page-css')
@endpush
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-datatable table-responsive pt-0">
                    <table class="datatables-basic table report-table" id="purchaseReturnReportTable">
                        <thead>
                            <tr>
                                <th>{{ __('SN') }}</th>
...
@push('page-js')
@routes
<script src="{{ asset('backend_assets/js/report/purchase_return_report.js') }}"></script>
@endpush
