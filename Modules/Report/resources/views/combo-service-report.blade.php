...
@section('page-title', __('Combo Service Sale Report'))
@push('page-css')
@endpush
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body filtered_information" id="filteredInformation">
                    <h5 class="card-title">{{ __('Combo Service Sale Report') }}</h5>
                    <div id="filterInfoContent"></div>
                </div>
                <div class="card-datatable table-responsive pt-0">
                    <table class="datatables-basic table report-table" id="comboServiceReportTable">
                        <thead>
                            <tr>
                                <th>{{ __('SN') }}</th>
                                <th>{{ __('Invoice No') }}</th>
...
@push('page-js')
@routes
<script src="{{ asset('backend_assets/js/report/combo_service_sale_report.js') }}"></script>
@endpush
