...
@section('page-title', __('Expire Soon Report'))
@push('page-css')
@endpush
            ...
            <form id="filterForm" onsubmit="event.preventDefault(); return false;" action="javascript:void(0);">
                <div class="row">
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control" id="generic_name" name="generic_name" value="{{ request('generic_name') }}" placeholder="{{ __('Generic Name') }}">
                    </div>
                    <div class="col-md-3 mb-3">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-datatable table-responsive pt-0">
                    <table class="datatables-basic table report-table" id="expireSoonReportTable">
                        <thead>
                            <tr>
                                <th>{{ __('SN') }}</th>
                                <th>{{ __('Item Code') }}</th>
                                <th>{{ __('Category') }}</th>
                                <th>{{ __('Stock Segmentation') }}</th>
                                <th>{{ __('Total Stock Quantity') }}</th>
                                <th>{{ __('Last Purchase Price') }}</th>
                                <th>{{ __('Total') }}</th>
                            </tr>
                        </thead>
                        <tbody>
...
@push('page-js')
@routes
<script src="{{ asset('backend_assets/js/report/expire_soon_report.js') }}"></script>
@endpush
