...
@section('page-title', __('Installment Collection Report'))
@push('page-css')
@endpush
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body filtered_information" id="filteredInformation">
                    <h5 class="card-title">{{ __('Installment Collection Report') }}</h5>
                    <div id="filterInfoContent"></div>
                </div>
                <div class="card-datatable table-responsive pt-0">
                    <table class="datatables-basic table report-table" id="installmentReportTable">
                        <thead>
                            <tr>
                                <th>{{ __('SN') }}</th>
                                <th>{{ __('Invoice No') }}</th>
                                ...
                                <th>{{ __('Product') }}</th>
                                <th>{{ __('Amount of Installment') }}</th>
...
@push('page-js')
@routes
<script src="{{ asset('backend_assets/js/report/installment_report.js') }}"></script>
@endpush
