...
@section('page-title', __('Due Sale Report'))
@push('page-css')
@endpush
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-datatable table-responsive pt-0">
                    <table class="datatables-basic table report-table" id="dueSaleReportTable">
                        <thead>
                            <tr>
                                <th>{{ __('SN') }}</th>
                                <th>{{ __('Invoice No') }}</th>
...
@push('page-js')
@routes
<script src="{{ asset('backend_assets/js/report/due_sale_report.js') }}"></script>
@endpush
