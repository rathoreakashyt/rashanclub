...
@section('page-title', __('Installment Due Report'))
@push('page-css')
@endpush
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-datatable table-responsive pt-0">
                    <table class="datatables-basic table report-table" id="installmentDueReportTable">
                        <thead>
                            <tr>
                                <th>{{ __('SN') }}</th>
                                <th>{{ __('Invoice No') }}</th>
                                <th>{{ __('Sale Date') }} & {{ __('Time') }}</th>
                                <th>{{ __('Customer') }} ({{ __('Phone') }})</th>
                                <th>{{ __('Product') }}</th>
                                <th>{{ __('Price') }}</th>
                                <th>{{ __('Percentage of Interest') }}</th>
                                <th>{{ __('Amount of Interest') }}</th>
                                <th>{{ __('Total') }}</th>
...
@push('page-js')
@routes
<script src="{{ asset('backend_assets/js/report/installment_due_report.js') }}"></script>
@endpush
