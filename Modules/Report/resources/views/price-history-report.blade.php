...
@section('page-title', __('Price History Report'))
@push('page-css')
@endpush
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-datatable table-responsive pt-0">
                    <table class="datatables-basic table report-table" id="priceHistoryReportTable">
                        <thead>
                            <tr>
                                <th>{{ __('SN') }}</th>
                                <th>{{ __('Date') }}</th>
...
@push('page-js')
@routes
<script src="{{ asset('backend_assets/js/report/price_history_report.js') }}"></script>
@endpush
