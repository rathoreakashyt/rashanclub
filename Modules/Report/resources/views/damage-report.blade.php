        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-datatable table-responsive pt-0">
                    <table class="datatables-basic table report-table" id="damageReportTable">
                        <thead>
                            <tr>
                                <th>{{ __('SN') }}</th>
...
@push('page-js')
@routes
<script src="{{ asset('backend_assets/js/report/damage_report.js') }}"></script>
@endpush
