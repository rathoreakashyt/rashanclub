...
@section('page-title', __('Stock Report'))
@push('page-css')
<style>
                        ...
                        <div class="d-flex align-items-center gap-4">
                            <div>
                                <h5 class="mb-0 text-danger">
                                    {{ __('Stock') }} {{ __('Value') }}: 
                                    <span id="stock_value_span" class="fw-bold">0.00</span>
                                </h5>
                            </div>
                            <div>
                                <h5 class="mb-0 text-danger">
                                    {{ __('Stock') }} {{ __('Count') }}: 
                                    <span id="stock_count_span" class="fw-bold">0</span>
                                </h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-header border-bottom p-3 d-flex flex-wrap justify-content-between align-items-center">
                        ...
                        <div class="dt-action-buttons text-end">
                            <div class="btn-group-stock">
                                <button type="button" class="btn btn-primary dropdown-toggle me-2" data-bs-toggle="dropdown" id="stockReportExportBtn">
                                ...
                                <button type="button" class="btn btn-primary" id="stockReportFilterBtn"><i class="ti tabler-filter me-sm-1"></i> <span class="d-none d-sm-inline-block">{{ __('Filter') }}</span></button>
                            </div>
                        </div>
                    </div>
                    <div id="stockReportLoading" class="text-center py-5 d-none">{{ __('Loading...') }}</div>
                    <div id="stockReportVirtualWrap" class="d-none">
                        <table class="datatables-basic table report-table report-table-header" id="stockReportTable">
                            <colgroup>
                                <col style="width: 5%">
                                <col style="width: 22%">
                                <col style="width: 12%">
                        ...
                        <div id="stockReportTableVirtual" class="report-virtual-container"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ __('Stock') }} {{ __('Details') }}</h5>
...
@push('page-js')
@routes
<script src="{{ asset('backend_assets/js/report/stock_report.js') }}"></script>
@endpush
