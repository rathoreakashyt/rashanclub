...
{
    public function __construct(private IncomeCategoryRepository $incomeCategoryRepository)
    {
    }
    ...
    public function getDataTable(int $length, int $start, ?string $search): array
    {
        ...
        $paginator = $this->incomeCategoryRepository->paginateWithFilters($length, $page, $search);

        $recordsTotal = $this->incomeCategoryRepository->countLive();
    ...
    {
        $category = $this->incomeCategoryRepository->findByEncryptedId($encryptedId);
        if (!$category) {
    ...
    public function update(string $encryptedId, array $data)
    {
        ...
        return $this->incomeCategoryRepository->update($category, $data);
    }

    public function delete(string $encryptedId)
    {
        $category = $this->getByEncryptedId($encryptedId);
        return $this->incomeCategoryRepository->softDelete($category);
    }

    public function listForSelect()
    {
        return $this->incomeCategoryRepository->listForSelect();
    }
}
