...
@section('page-title', __('List') . ' ' . __('Payment_Method'))
@push('page-css')
...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
        <div class="d-flex flex-column justify-content-center">
            <h4 class="mb-0">{{ __('List') }} {{ __('Payment_Method') }}</h4>
        </div>
        @include('backend.components.breadcrumb', [
            'breadcrumbs' => [
                ...
                [
                    'label' => __('List') . ' ' .  __('Payment_Method'),
                    'active' => true
                ]
            ]
        ])
                ...
                <div class="card-datatable table-responsive pt-0">
                    <table class="datatables-basic table">
                        <thead>
                            <tr>
                                <th>{{ __('SN') }}</th>
                                <th>{{ __('Account') }} {{ __('Name') }}</th>
                                <th>{{ __('Account') }} {{ __('Type') }}</th>
                                <th>{{ __('Status') }}</th>
                                <th>{{ __('Balance') }}</th>
                                <th>{{ __('Action') }}</th>
                            </tr>
...
<script src="{{ asset('backend_assets/js/pages_list_js/list_payment_method.js')}}"></script>
