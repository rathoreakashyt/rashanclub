...
{
    public partial class CreatePurchasePage : UserControl
    {
        private readonly DatabaseService _db = new DatabaseService();
        private readonly MainDashboard? _dashboard;

        public CreatePurchasePage() { InitializeComponent(); }
        public CreatePurchasePage(MainDashboard dashboard) : this() { _dashboard = dashboard; }
        ...
        private void BtnBack_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (parent != null)
            {
                ...
                parent.Children.Add(new PurchasePage(_dashboard!));
            }
        }
        ...
        private void BtnSave_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                string vchCode = "PUR" + DateTime.Now.ToString("yyyyMMddHHmmss");
                ...
                cmd.CommandText = @"INSERT INTO Tran1 (VchCode, VchType, VchNo, VchDate, VchSeriesCode, Narration, Amount, IsCancelled, CreatedAt, UpdatedAt)
                    VALUES (@code, 'Purchase', @vno, @vdate, @series, @narr, 0, 0, datetime('now'), datetime('now'))";
                ...
                var parent = Parent as Panel;
                if (parent != null) { parent.Children.Clear(); parent.Children.Add(new PurchasePage(_dashboard!)); }
            }
            catch (Exception ex)
            {
