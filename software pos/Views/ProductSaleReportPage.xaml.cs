...
{
    public partial class ProductSaleReportPage : UserControl
    {
        private readonly MainDashboard? _dashboard;
        private readonly DatabaseService _db = new();
        private DataTable? _currentTable;

        public ProductSaleReportPage(MainDashboard? dashboard)
        {
            InitializeComponent();
            ReportPdfHelper.Attach(exportPopup, () => dataGrid.ItemsSource as DataView, "Product Sale Report");
        ...
        private void LoadData()
        {
            ...
            var sql = "SELECT ROW_NUMBER() OVER (ORDER BY s.sale_date DESC, sd.Id DESC) AS sn,"
                ...
                + " (SELECT COUNT(*) FROM sale_details sd2 WHERE sd2.sales_id = sd.sales_id AND (sd2.del_status IS NULL OR sd2.del_status='Live')) AS items,"
                + " IFNULL(i.name, '') || CASE WHEN i.code IS NOT NULL AND i.code != '' THEN ' (' || i.code || ')' ELSE '' END AS item_product,"
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("Error: " + ex.Message, "Product Sale Report", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private void ShowFilterInfo()
        {
            ...
            AddInfo("Report", "Product Sale Report");
        ...
        private void BtnExportCsv_Click(object sender, RoutedEventArgs e)
        {
            ...
            var dlg = new SaveFileDialog { Filter = "CSV (*.csv)|*.csv", FileName = "ProductSaleReport_" + DateTime.Today.ToString("yyyyMMdd") + ".csv" };
        ...
        private void BtnPrint_Click(object sender, RoutedEventArgs e)
        {
            ...
            doc.Blocks.Add(new Paragraph(new Run("Product Sale Report")) { FontSize = 16, FontWeight = FontWeights.Bold, Margin = new Thickness(0, 0, 0, 6) });
            ...
            dlg.PrintDocument(pag, "Product Sale Report");
        }
    }
}
