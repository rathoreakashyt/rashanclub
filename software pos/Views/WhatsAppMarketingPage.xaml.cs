...
{
    public partial class WhatsAppMarketingPage : UserControl
    {
        ...
        public WhatsAppMarketingPage(MainDashboard? dashboard)
        {
            InitializeComponent();
        ...
        private void UpdateCustomCount()
        {
            ...
            {
                txtCustomAlertMsg.Text = "This WhatsApp message will be sent to every customer with a valid phone number.";
                runCustomRecipients.Text = _eligibleCount.ToString();
            }
            else
            {
                txtCustomAlertMsg.Text = "This WhatsApp message will be sent only to the customers you selected above.";
            }
        }
        ...
        private void BtnSendBirthday_Click(object sender, RoutedEventArgs e)
        {
            ...
            foreach (var phone in contacts)
            {
                string uri = $"https://wa.me/{phone}?text={msg}";
