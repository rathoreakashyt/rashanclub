    ...
    new DataTable(dt_basic_table, {
      ...
      ajax: {
        ...
        error: function(xhr, error, thrown) {
          console.error('Expense list AJAX error:', error, thrown);
        }
      },
      columns: [
        { data: 'id' },
        ...
        { 
          ...
          render: function(data) {
            ...
            const edit_url = route('expense.edit', { expense: data.encrypted_id }, false, Ziggy);
            const destroy_url = route('expense.destroy', { expense: data.encrypted_id }, false, Ziggy);
      ...
      buttons: [
        ...
        {
          text: '<i class="ti tabler-plus me-sm-1"></i> <span class="d-none d-sm-inline-block">'+language_key['Add Expense']+'</span>',
          className: 'btn create-new btn-primary',
          action: function (e, dt, node, config) {
            window.location.href = base_url + '/expense/create';
          }
        }
      ],
